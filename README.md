# JPA One To One Unidirectional example with Hibernate and Spring Boot
Implement JPA/Hibernate One-To-One Unidirectional mapping with Hibernate in a Spring Boot CRUD example using `@OneToOne` annotation
 
- configure Spring Data, JPA, Hibernate to work with Database
- define Data Models and Repository interfaces for JPA One-To-One Unidirectional relationship
- use Spring JPA to interact with Database for One-To-One association
